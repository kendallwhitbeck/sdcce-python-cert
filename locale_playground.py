...
locale.setlocale(locale.LC_ALL); print(f"locale.setlocale(locale.LC_ALL): {locale.getlocale()}")

locale.setlocale(locale.LC_ALL, ''); print(locale.getlocale())  # use and print user's preferred locale
